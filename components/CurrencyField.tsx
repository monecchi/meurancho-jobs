...
import { NumericFormat as NumberFormat, NumericFormatProps} from 'react-number-format'
...
export const CurrencyField: React.FC<CurrencyProps> = (props: CurrencyProps) => {
	...
	const handleChange = (v: any) => {
		...
		if (props.onValueChange) {
			// @ts-ignore
			props.onValueChange({ ...v, floatValue: v.floatValue / 100 });
		}
	};
	...
	const keyDown = (e: any, value: number) => {
